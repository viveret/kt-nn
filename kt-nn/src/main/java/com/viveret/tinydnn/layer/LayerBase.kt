...
import com.viveret.tinydnn.data.graphics.LayerImage
import com.viveret.tinydnn.data.graphics.LayerVizualization
import com.viveret.tinydnn.data.graphics.VizualizationSubject
import com.viveret.tinydnn.model.IModel
import com.viveret.tinydnn.network.Edge
import com.viveret.tinydnn.network.Layer
import com.viveret.tinydnn.network.Node
...
open class LayerBase(nativeObjectHandle: Long) : Layer<Any>, IModel<Layer<Any>> {
    ...
    override fun getVisualizations(): List<LayerVizualization> {
        ...
        if (imgHandle != 0L) {
            ...
            ret.add(LayerVizualization(VizualizationSubject.Outputs, image))
        }
        return ret
    }
