...
Java_com_viveret_tinydnn_basis_Index3D_staticConstructor(
...
extern "C"
JNIEXPORT jlong JNICALL
Java_com_viveret_tinydnn_basis_Index3D_jniGetWidth(
        JNIEnv* env, jobject thiz,
        jlong handle) {
    auto fn = [&]() {
...
extern "C"
JNIEXPORT jlong JNICALL
Java_com_viveret_tinydnn_basis_Index3D_jniGetHeight(
        JNIEnv* env, jobject thiz,
        jlong handle) {
    auto fn = [&]() {
...
extern "C"
JNIEXPORT jlong JNICALL
Java_com_viveret_tinydnn_basis_Index3D_jniGetDepth(
        JNIEnv* env, jobject thiz,
        jlong handle) {
    auto fn = [&]() {
