...
Java_com_viveret_tinydnn_data_graphics_LayerImage_jniConstructor(
...
Java_com_viveret_tinydnn_data_graphics_LayerImage_jniResize(JNIEnv *env, jobject thiz,
...
Java_com_viveret_tinydnn_data_graphics_LayerImage_jniGetPixelData(JNIEnv *env, jobject thiz,
                                                                   jlong handle) {
    auto fn = [&]() {
...
Java_com_viveret_tinydnn_data_graphics_LayerImage_jniGetFormat(JNIEnv *env, jobject thiz,
                                                                    jlong handle) {
    auto fn = [&]() {
...
extern "C"
JNIEXPORT jlong JNICALL
Java_com_viveret_tinydnn_data_graphics_LayerImage_jniGetWidth(JNIEnv *env, jobject thiz,
                                                                   jlong handle) {
    auto fn = [&]() {
...
extern "C"
JNIEXPORT jlong JNICALL
Java_com_viveret_tinydnn_data_graphics_LayerImage_jniGetHeight(JNIEnv *env, jobject thiz,
                                                                    jlong handle) {
    auto fn = [&]() {
...
extern "C"
JNIEXPORT jlong JNICALL
Java_com_viveret_tinydnn_data_graphics_LayerImage_jniGetDepth(JNIEnv *env, jobject thiz,
                                                                  jlong handle) {
    auto fn = [&]() {
...
Java_com_viveret_tinydnn_data_graphics_LayerImage_jniEmpty(JNIEnv *env, jobject thiz,
                                                                  jlong handle) {
    auto fn = [&]() {
