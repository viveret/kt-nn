...
class MaxUnpoolingLayer private constructor(nativeObjectHandle: Long) : LayerBase(nativeObjectHandle) {
     ...
     **/
    @UserConstructor(R2.string.layer_max_unpool, 0)
    constructor(@UserField(UserFields.InWidth) in_width: Long,
                ...
                @CustomUserField(R2.string.unpooling_size, R2.string.unpool_size_hint, InputType.TYPE_CLASS_NUMBER) unpooling_size: Long,
